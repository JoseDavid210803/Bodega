...
public class MyApplication extends Application {
    ...
    public void onCreate()
    {
        ...
        //ticket 2
        ticket ticket_entrada2 = new ticket(new Date());
        ...
        // Generar ticket 3
        ticket ticket_entrada3 = new ticket(new Date());
        ...
        // Generar ticket 4
        ticket ticket_entrada4 = new ticket(new Date());
        ...
        // Generar ticket 5
        ticket ticket_entrada5 = new ticket(new Date());
        ...
        //Genera ticket 1
        ticket ticket_salida1 = new ticket(new Date());
        ...
        // Generar ticket 2
        ticket ticket_salida2 = new ticket(new Date());
        ...
        // Generar ticket 3
        ticket ticket_salida3 = new ticket(new Date());
        ...
        // Generar ticket 4
        ticket ticket_salida4 = new ticket(new Date());
        ...
        // Generar ticket 5
        ticket ticket_salida5 = new ticket(new Date());
