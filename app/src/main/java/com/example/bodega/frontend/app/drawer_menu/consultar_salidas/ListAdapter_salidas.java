...
public class ListAdapter_salidas extends RecyclerView.Adapter<ListAdapter_salidas.ViewHolder> {
    private List<ticket> mData;
    private final LayoutInflater mInflater;

    public ListAdapter_salidas(List<ticket> itemList, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        View view=mInflater.inflate(R.layout.salida_element, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(View itemView){
            ...
            name=itemView.findViewById(R.id.id_salidaTextView);
            cantidad=itemView.findViewById(R.id.cantidad_salidaTextView);
        ...
        void bindData(final ticket item){
            name.setText(truncateText("Salida N°" + item.getId()));
