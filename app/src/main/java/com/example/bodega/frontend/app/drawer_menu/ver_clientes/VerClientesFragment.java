...
import com.example.bodega.frontend.app.drawer_menu.ver_clientes.ListAdapterClientes;


import java.util.ArrayList;
import java.util.List;

public class VerClientesFragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        com.example.bodega.databinding.FragmentVerClientesBinding binding = FragmentVerClientesBinding.inflate(inflater, container, false);
        rootView = binding.getRoot();
        MyApplication myApp = (MyApplication) requireContext().getApplicationContext();
        elements = myApp.getClientes();
    ...
    public void init() {
        ...
        ListAdapterClientes listAdapter = new ListAdapterClientes(elements, context);
        RecyclerView recyclerView = rootView.findViewById(R.id.clientes_recyclerview);
