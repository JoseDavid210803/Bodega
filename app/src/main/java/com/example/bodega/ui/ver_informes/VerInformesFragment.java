...
import com.example.bodega.ui.ver_informes.VerInformesViewModel;
...
public class VerInformesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        VerInformesViewModel VerInformesViewModel =
                new ViewModelProvider(this).get(com.example.bodega.ui.ver_informes.VerInformesViewModel.class);
